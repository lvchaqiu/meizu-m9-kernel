...
KBUILD_LDS_MODULE     := -T $(srctree)/arch/$(SRCARCH)/module.lds
KBUILD_LDFLAGS_MODULE  = $(if $(wildcard arch/$(SRCARCH)/module.lds), $(KBUILD_LDS_MODULE))
...
export CFLAGS_SECTIONS LDFLAGS_GCS
