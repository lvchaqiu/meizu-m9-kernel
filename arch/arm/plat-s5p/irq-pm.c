...
unsigned long s3c_irqwake_intallow	= 0x0000000fL;
/* allow eint0(usb), eint2(key off), eint3(key home), eint4(low bat),
 *  eint6(charge), eint8(SRDY), eint9(WIFI), eint11(bt_wake), eint14(modem reset) 
 *  as awake source
 */
unsigned long s3c_irqwake_eintallow	= 0x00004b5dL;
#else
