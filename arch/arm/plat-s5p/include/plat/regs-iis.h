...
#define S5P_IISMOD_OPCLK_MASK		(3<<30)
#define S5P_IISMOD_OPCLK_CDCLK_OUT		(0<<30)
#define S5P_IISMOD_OPCLK_CDCLK_IN		(1<<30)
#define S5P_IISMOD_OPCLK_BCLK_OUT		(2<<30)
#define S5P_IISMOD_OPCLK_PCLK		(3<<30)
...
#define S3C64XX_IISMOD_SLAVE		(2 << 10)
