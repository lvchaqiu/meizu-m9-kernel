...
#define IOCTL_JPG_GET_BUF_INFO            		_IO(JPEG_IOCTL_MAGIC, 9)
#define IOCTL_JPG_GET_LIMIT_INFO            		_IO(JPEG_IOCTL_MAGIC, 10)
#define IOCTL_JPG_SET_PHY_FRMBUF            		_IO(JPEG_IOCTL_MAGIC, 11)
#define IOCTL_JPG_INVALIDE_CACHE        _IO(JPEG_IOCTL_MAGIC, 12)
#define IOCTL_JPG_CLEAN_CACHE        _IO(JPEG_IOCTL_MAGIC, 13)
