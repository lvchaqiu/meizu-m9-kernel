...
#ifndef __section_used
# define __section_used(S) \
        __attribute__ ((used, __section__(__usym(S))))
#endif

#ifndef __section_used_str
# define __section_used_str(S) \
        __attribute__ ((used, __section__(__ustr(S))))
#endif

#ifndef __section_used_aligned
# define __section_used_aligned(S, n) \
        __attribute__ ((used, __aligned__(n), __section__(__usym(S))))
#endif

#ifndef __section_used_aligned_str
# define __section_used_aligned_str(S, n) \
        __attribute__ ((used, __aligned__(n), __section__(__ustr(S))))
#endif
