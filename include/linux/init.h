...
#define __exit_call	__section_used(.exitcall.exit)
...
#define __define_initcall(fn,id) \
	...
	__section_used_str(".initcall" __stringify(id) ".init") = fn
...
#define console_initcall(fn) \
	...
	__section_used(.con_initcall.init) = fn

#define security_initcall(fn) \
	static initcall_t __initcall_##fn \
	__section_used(.security_initcall.init) = fn
