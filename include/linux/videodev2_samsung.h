...
{
	V4L2_CAMERA_PREVIEW	=	0,
	V4L2_CAMERA_RECORD	=	1,
	V4L2_CAMERA_CAPTURE	=	2,
};
...
#define V4L2_CID_CAMERA_EXPOSURE_POSITION		(V4L2_CID_PRIVATE_BASE + 130)
enum v4l2_exposure_mode
{
	V4L2_EXPOSURE_AVERAGE_1	=	0,/*Average of one image*/
	V4L2_EXPOSURE_CENTER_1	=	1,/*left to right : 0 - 4- 0*/
	V4L2_EXPOSURE_CENTER_2	=	2,/*left to right : 0.7 - 2 - 0.7*/
	V4L2_EXPOSURE_CENTER_3	=	3,/*left to right : 0.5 - 2 - 4 - 2 - 0.5*/
	V4L2_EXPOSURE_CENTER_4	=	4,/*left to right : 0.5 - 1.5 - 0.5*/
	V4L2_EXPOSURE_AVERAGE_2	=	5,/*same V4L2_EXPOSURE_AVERAGE_1*/
	V4L2_EXPOSURE_AVERAGE_3	=	6,/*same V4L2_EXPOSURE_AVERAGE_1*/
	V4L2_EXPOSURE_AVERAGE_4	=	7,/*same V4L2_EXPOSURE_AVERAGE_1*/
	V4L2_EXPOSURE_BOTTOM_1	=	8, /*top to bottom : 0.5 - 1 - 2 - 1*/
	V4L2_EXPOSURE_BOTTOM_2	=	9,	 /*top to bottom : 0.25 - 2 - 2 - 2*/
	V4L2_EXPOSURE_LEFT_1	=	10,  /*left to right : 1 - 2 - 1 - 0.5*/
	V4L2_EXPOSURE_LEFT_2	=	11,	/*left to right : 2 - 2 - 2 - 0.5*/
	V4L2_EXPOSURE_TOP_1	=	12,   /*top to bottom : 1 - 2 - 1 - 0.5*/
	V4L2_EXPOSURE_TOP_2	=	13,   /*top to bottom : 2 - 2 - 1 - 0.25*/
	V4L2_EXPOSURE_RIGHT_1	=	14,  /*left to right : 0.5 - 1 - 2 - 1*/
	V4L2_EXPOSURE_RIGHT_2	=	15,	/*left to right : 0.25 - 2 - 2 - 2*/
};
